  ...
  <nav id="mainNavbar" aria-label="Sections" class="fixed top-0 left-0 w-full select-none dark:bg-dark/95 bg-light/95 backdrop-blur-md border-b border-black/10 dark:border-white/10" style="z-index: var(--z-nav);">
    <div class="flex items-center justify-between gap-2 px-3 sm:px-6 lg:px-10 h-14">
      ...
      <button
        ...
        <svg class="h-6 w-auto transition-[transform,fill] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-110 dark:fill-dark-primary fill-light-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 745.03 831.62">
          <g>
      ...
      <div class="flex items-center gap-0.5 sm:gap-3">
        <button
          ...
          <span
            ...
            :class="activeSlide === item.idx ? 'scale-x-100' : 'scale-x-0 opacity-60 group-hover:scale-x-100'"></span>
        </button>
      </div>
